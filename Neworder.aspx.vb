            ...
            If checkbox.Checked Then
                ...
                Try
                    ...
                    If (DropDownList1.Text = "Approve") Then
                        ...
                        Dim Message As String = "Dear " & dt.Tables(0).Rows(0)("UName") & "," & vbCrLf & vbCrLf & "Your Order has been placed and seller has processed your order" & vbCrLf & vbCrLf & "Product Name : " & dt.Tables(0).Rows(0)("Pname") & vbCrLf & "Delivery Address: " & dt.Tables(0).Rows(0)("UAddress") & vbCrLf & vbCrLf & "Thankyou for being a part of bharat medical"
