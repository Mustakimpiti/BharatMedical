<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="false" CodeFile="Approveorder.aspx.vb" Inherits="Admin_Default2" %>
            ...
            <div class="auth-content">
                <div class="card">
                    <div class="card-body text-start">
                        <h1 class="mb-3 text-muted">All Approved Orders</h1>
...
<%--                                    <asp:BoundField DataField="Image" HeaderText="Image" SortExpression="Image" />--%>
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <%# If(Eval("Orderstatus").ToString() = "Approve", "<img class='icon-colored' src='../Admin/assets/img/a1.png' style =' height:50px; width:50px;'  alt='colored-icons'>",
                                                                                                                            If(Eval("Orderstatus").ToString() = "Pending", " <img class='icon-colored' src='../Admin/assets/img/p2.png' style =' height:50px; width:50px;'  alt='colored-icons'>",
                                                                                                                            "")) %>
                                            <%# If(Eval("Orderstatus").ToString() = "Shipped", "<img class='icon-colored' src='../Admin/assets/img/ship.png' style =' height:50px; width:50px;'  alt='colored-icons'>",
                                                                                                                                                                                                                                        If(Eval("Orderstatus").ToString() = "Delivered", " <img class='icon-colored' src='../Admin/assets/img/d2.jpg' style =' height:40px; width:50px;'  alt='colored-50px'>",
                                                                                                                                                                                                                                        "")) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Ordermaster] where [Orderstatus]=@Orderstatus">
                                <selectparameters>
                            <asp:Parameter Name="Orderstatus" DefaultValue="Approve" Type="String" />
                        </selectparameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
