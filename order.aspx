<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="false" CodeFile="order.aspx.vb" Inherits="Admin_Default2" %>
            ...
            <div class="auth-content">
                <div class="card">
                    <div class="card-body text-start"><div class="row text-center">
                        <h1 class="mb-3 text-muted">All Orders</h1></div>
                        ...
                        &nbsp<asp:Button id="DeleteSelectedProducts" runat="server" CssClass="btn-danger" Text="Delete" />
...
<%--                                    <asp:BoundField DataField="Image" HeaderText="Image" SortExpression="Image" />--%>
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <%# If(Eval("Orderstatus").ToString() = "Approve", "<img class='icon-colored' src='../Admin/assets/img/a1.png' style =' height:35px; width:35px;'  alt='colored-icons'>",
                                                                                        If(Eval("Orderstatus").ToString() = "Pending", " <img class='icon-colored' src='../Admin/assets/img/p2.png' style =' height:35px; width:35px;'  alt='colored-icons'>",
                                                                                        "")) %>
                                            <%# If(Eval("Orderstatus").ToString() = "Shipped", "<img class='icon-colored' src='../Admin/assets/img/ship.png' style =' height:35px; width:35px;'  alt='colored-icons'>",
                                                                                                                                                                                                    If(Eval("Orderstatus").ToString() = "Delivered", " <img class='icon-colored' src='../Admin/assets/img/d2.jpg' style =' height:40px; width:40px;'  alt='colored-icons'>",
                                                                                                                                                                                                    "")) %>
                                             <%# If(Eval("Orderstatus").ToString() = "Shipped", "",
                                                                                                                                                                                                                            If(Eval("Orderstatus").ToString() = "Packed", " <img class='icon-colored' src='../Admin/assets/img/packed.png' style =' height:40px; width:40px;'  alt='colored-icons'>",
                                                                                                                                                                                                                            "")) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Ordermaster]"></asp:SqlDataSource>
                        </div>
                    </div>
                </div>
            </div>
