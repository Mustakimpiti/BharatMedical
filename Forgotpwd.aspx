<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Forgotpwd.aspx.vb" Inherits="Admin_Forgotpwd" %>
                ...
                <div class="card text-start" style="width: 50%;">
                    <div class="card-body"><br /><br /><br /><br /><br /><br /><br />
                        ...
                        <div class="text-start">
                            ...
                            <br />
                            <asp:Button ID="btnsave" cssclass="btn btn-primary shadow-2 mb-4" runat="server" Text="Send" />
                        <br />
                            <p class="mb-2 text-muted">Click For <a href="Login.aspx">Signin</a></p>
