<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="false" CodeFile="Shipped.aspx.vb" Inherits="Admin_Default2" %>
            ...
            <div class="auth-content">
                <div class="card">
                    <div class="card-body text-start"><div class="row text-center">
                        <h1 class="mb-3 text-muted">All Shipped Orders</h1></div>
...
<%--                                    <asp:BoundField DataField="Image" HeaderText="Image" SortExpression="Image" />--%>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Ordermaster] where [Orderstatus]=@Orderstatus">
                                <selectparameters>
                            <asp:Parameter Name="Orderstatus" DefaultValue="Shipped" Type="String" />
                        </selectparameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
