<%@ Page Title="" Language="VB" MasterPageFile="~/user/user.master" AutoEventWireup="false" CodeFile="special2.aspx.vb" Inherits="user_Default" %>
...
<%--                       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:DropDownList ID="ddlcat" AutoPostBack="true" runat="server">
                            <asp:ListItem Text="All" Value=""></asp:ListItem>
                                    <asp:ListItem>Standard</asp:ListItem>
                                    <asp:ListItem>Generic</asp:ListItem>
...
<%--                            <h1><asp:Label ID="Label2" runat="server" Text="10% OFF ON THIS ALL MEDICINES" Font-Bold="True" Font-Italic="True"></asp:Label></h1>--%>
