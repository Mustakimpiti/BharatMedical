        ...
        For Each row As GridViewRow In GridView1.Rows
            ...
            If checkbox.Checked Then
                ...
                Try
                    ...
                    If (DropDownList1.Text = "Packed") Then
                        Dim SM As New SendMail()
                        Dim Message As String = "Dear " & dt.Tables(0).Rows(0)("UName") & "," & vbCrLf & vbCrLf & "Your order has been picked up by the courier partner" & vbCrLf & vbCrLf & "Product Name : " & dt.Tables(0).Rows(0)("Pname") & vbCrLf & "Delivery Address: " & dt.Tables(0).Rows(0)("UAddress") & vbCrLf & vbCrLf & "Thankyou for being a part of bharat medical"
