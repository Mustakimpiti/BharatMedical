<%@ Page Title="" Language="VB" MasterPageFile="~/user/user.master" AutoEventWireup="false" CodeFile="special.aspx.vb" Inherits="user_Default2" %>
...
<%--                                <h1><asp:Label ID="Label2" runat="server" Text="25% OFF ON THIS ALL MEDICINES" Font-Bold="True" Font-Italic="True"></asp:Label></h1>--%>
