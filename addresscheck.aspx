<%@ Page Title="" Language="VB" MasterPageFile="~/user/user.master" AutoEventWireup="false" CodeFile="addresscheck.aspx.vb" Inherits="user_Default2" %>
        ...
        <div class="auth-content">
            <center>
                <div class="card text-center" style="width: 50%;">
                    <div class="card-body">
                        <div class="mb-4">
                            <h3 class="mb-4 text-muted "> <asp:Label ID="lbtitle" runat="server" Text="Edit Address" Font-Bold="True"></asp:Label></h3>
