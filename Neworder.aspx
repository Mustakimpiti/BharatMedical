<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="false" CodeFile="Neworder.aspx.vb" Inherits="Admin_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript">
function Openpopup(popurl)
{
winpops = window.open(popurl,"car","width=500px, height=500, left=100, top=50, scrollbars=yes, menubar=no,resizable=no,directories=no,location=no")
}
    </script>
    <div class="content">
        <div class="container">
            ...
            <div class="auth-content">
                <div class="card">
                    <div class="card-body text-start"><div class="row text-center">
                        <h1 class="mb-3 text-muted">All New Orders</h1></div>
...
<%--                                    <asp:BoundField DataField="Image" HeaderText="Image" SortExpression="Image" />--%>
                                    <asp:TemplateField HeaderText="Priscription">
                                            <ItemTemplate>
                                                <a href="javascript:Openpopup('img.aspx?PId=<%# Eval("Orderid") %>')">
                                                <asp:Image ID="img2" Width="80"  Height="80" runat="server" ImageUrl='<%#Bind("Priscription") %>' />
                                   ...
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <%# If(Eval("Orderstatus").ToString() = "Approve", "<img class='icon-colored' src='../Admin/assets/img/a1.png' style =' height:50px; width:50px;'  alt='colored-icons'>", If(Eval("Orderstatus").ToString() = "Pending", " <img class='icon-colored' src='../Admin/assets/img/p2.png' style =' height:50px; width:50px;'  alt='colored-icons'>", "<img class='icon-colored' src='../Admin/pages/icons/' style =' height:18px; width:18px;' alt='colored-icons'>")) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Ordermaster] where [Orderstatus]=@Orderstatus">
                                <selectparameters>
                            <asp:Parameter Name="Orderstatus" DefaultValue="Pending" Type="String" />
                        </selectparameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
