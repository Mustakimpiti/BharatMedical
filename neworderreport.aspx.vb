    ...
    Protected Sub ExportToPDF(sender As Object, e As EventArgs)
        ...
        Using sw As New StringWriter()
            Using hw As New HtmlTextWriter(sw)
                ...
                pdfDoc.Add(logo)
                Dim header As New Paragraph("New Orders Report " & Date.Today() & vbCrLf & vbCrLf & vbCrLf & vbCrLf)
                ...
                Response.AddHeader("content-disposition", "attachment;filename=New Order.pdf")
