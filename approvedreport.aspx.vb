...
Partial Class Admin_Default2
    ...
    Private Sub SearchMed()
        ...
        cmd.Parameters.AddWithValue("@Orderstatus", "Approve")
    ...
    Protected Sub ExportToPDF(sender As Object, e As EventArgs)
        ...
        Using sw As New StringWriter()
            Using hw As New HtmlTextWriter(sw)
                ...
                pdfDoc.Add(logo)
                Dim header As New Paragraph("Approved Orders Report " & Date.Today() & vbCrLf & vbCrLf & vbCrLf & vbCrLf)
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Approve Order.pdf")
